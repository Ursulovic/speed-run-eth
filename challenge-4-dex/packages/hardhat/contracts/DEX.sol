...
contract DEX {
	...
	function init(uint256 tokens) public payable returns (uint256) {
		...
		require(token.transferFrom(msg.sender, address(this), tokens), "Not enough ballons!");
	...
	function ethToToken() public payable returns (uint256 tokenOutput) {
		...
		uint256 output = price(ethInput, ethReserves, tokenReserves);
	...
	function tokenToEth(
		...
		require(ethOutput >= 0, "Must require some eth");
